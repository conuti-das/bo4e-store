...
import de.macoapp.bo4e.IntegrationTest;
import de.macoapp.bo4e.config.Constants;
import de.macoapp.bo4e.domain.Authority;
import de.macoapp.bo4e.domain.User;
import de.macoapp.bo4e.repository.AuthorityRepository;
import de.macoapp.bo4e.repository.EntityManager;
import de.macoapp.bo4e.repository.UserRepository;
import de.macoapp.bo4e.repository.search.UserSearchRepository;
import de.macoapp.bo4e.security.AuthoritiesConstants;
import de.macoapp.bo4e.service.dto.AdminUserDTO;
import de.macoapp.bo4e.service.mapper.UserMapper;
