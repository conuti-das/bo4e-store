package de.macoapp.bo4e.web.rest;

import de.macoapp.bo4e.config.Constants;
import de.macoapp.bo4e.domain.User;
import de.macoapp.bo4e.repository.UserRepository;
import de.macoapp.bo4e.security.AuthoritiesConstants;
import de.macoapp.bo4e.service.MailService;
import de.macoapp.bo4e.service.UserService;
import de.macoapp.bo4e.service.dto.AdminUserDTO;
import de.macoapp.bo4e.web.rest.errors.BadRequestAlertException;
import de.macoapp.bo4e.web.rest.errors.EmailAlreadyUsedException;
import de.macoapp.bo4e.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link de.macoapp.bo4e.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
